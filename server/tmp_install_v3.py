...
r = subprocess.run(plink + ['DOMAIN=test.kuban-forum.ru PANEL_PASS=<пароль_panel_test> EMAIL=furi_wave@mail.ru bash /root/install.sh 2>/root/install_err.log'], capture_output=True, text=True, timeout=600)
