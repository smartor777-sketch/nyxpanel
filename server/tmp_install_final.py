...
r = subprocess.run(plink + ['nohup bash -c "DOMAIN=test.kuban-forum.ru PANEL_PASS=<пароль_panel_test> EMAIL=furi_wave@mail.ru bash /root/install.sh" > /root/install.log 2>&1 &'], capture_output=True, text=True, timeout=30)
