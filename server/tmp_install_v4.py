...
r = subprocess.run(plink + ['DOMAIN=test.kuban-forum.ru PANEL_PASS=<пароль_panel_test> EMAIL=furi_wave@mail.ru nohup bash /root/install.sh > /root/install_out.log 2>&1 &'], capture_output=True, text=True, timeout=30)
